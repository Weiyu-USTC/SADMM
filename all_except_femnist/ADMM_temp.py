...
class Machine:
    def __init__(self, data_x, data_y, machine_id):
        ...
        self.beta1 = np.zeros((10,785))
        self.beta0 = np.zeros((10,785))
    ...
    def update(self, theta0, theta, alpha, l1_lambda, weight_lambda, delta):
        ...
        self.beta1 = self.beta0 + (alpha/2)*(theta0 - theta)
...
class Parameter_server:
    def __init__(self):
        ...
        self.beta1 = np.zeros((10,785))
        self.beta0 = np.zeros((10,785))
        self.beta = np.zeros([num_machines,10,785])
    ...
    def broadcast(self, theta0, theta_li, alpha, l1_lambda, weight_lambda, delta):
        ...
        same_attack = np.random.standard_normal((10,785)) * 10000
        ...
        new_theta0 = theta0 + (1/(delta + num_machines*alpha))*(2*self.beta1 - self.beta0 - weight_lambda*theta0)
        self.beta0 = self.beta1
    ...
    def train(self, init_theta0, init_theta, alpha, l1_lambda, weight_lambda, d):
       ...
       # delta = 0.01
        ...
        print("train end!")
        #print('master:', rec_theta0)
        #print('server:', rec_theta)
